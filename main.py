...
dataTransforms = transforms.Compose([
    ...
    transforms.RandomPerspective(distortion_scale=0.2, p=0.2), # Randomly apply perspective transformation with a probability of 0.2
    transforms.RandomAffine(degrees=0, translate=(0.1, 0.1), scale=(0.9, 1.1), shear=10), # Randomly apply affine transformation
